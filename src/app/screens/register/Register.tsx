...
const Register: React.FC = () => {
  ...
  return (
    <section className="register-page d-flex justify-content-center align-items-center vh-100">
      <div className="register-form animate__animated animate__fadeIn">
        <h2 className="text-center fw-bold mb-4">
          Regístrate en <span className="text-primary">FullChamba</span>
        </h2>
        ...
        <div className="mb-4">
          ...
          <div className="position-relative">
            ...
            >
              {showPassword ? (
                <i className="bi bi-eye-slash fs-5" />
              ) : (
